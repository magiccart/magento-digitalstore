 ...
 * @@Modify Date: 2018-05-16 14:30:39
 * @@Function:
 */
...
class Magiccart_Magicmenu_Block_Menu extends Mage_Catalog_Block_Navigation
{
    ...
    public function drawHomeMenu()
    {
        ...
        $drawHomeMenu .= '<a class="level-top" href="'.Mage::helper('core/url')->getHomeUrl().'"><span class="icon fa fa-home"></span><span class="icon-text">' .$this->__('Home') .'</span>';
        $drawHomeMenu .= '</a>';
						...
						$desktopTmp .= '<div class="content-mega-horizontal">';
							...
							if($hasChild) :
								...
								if($childTop){
									...
									$desktopTmp .= $blocks['bottom'] ? '<li>'  .$blocks['bottom']. '</li>' : '';
